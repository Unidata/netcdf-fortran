...
Please see AI tool use guidelines found here: [NSF Unidata AI Tool Guidelines](https://github.com/Unidata/netcdf-fortran/blob/main/.github/AI_GUIDELINES.md).

# Workflow <A NAME="workflow"></A>

The process for contributing a patch to netCDF roughly follows the following workflow:

* (Optional) Open an issue [on GitHub](http://github.com/Unidata/netcdf-fortran/issues).
...
* Fork the [Unidata/netcdf-fortran](http://github.com/Unidata/netcdf-fortran) repository.
* Make the desired changes to the netcdf-fortran project.
...
We provide several Docker images for performing regression tests against netcdf-fortran.  These tests build and test `libnetcdf`, and then use it as the basis for testing the following packages:
