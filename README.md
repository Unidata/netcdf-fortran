...
data.  It depends on the netCDF C libray, which must be installed
first.  Other separate software distributions available from Unidata
provide C Java, C++, and Python.  They have been tested on various
common platforms.
...
You can obtain a copy of the latest released versions of netCDF
software from
